...
function minMax(arraynumber) {
    for (let i = 0; i< arraynumber.length; i++)
    {
        ...
        let minToMax = arraynumber[i];
        arraynumber[i]=arraynumber[min];
        arraynumber[min]=minToMax;
    }
}
let arrayMinMax = [1,4,2,5,3,6]
minMax(arrayMinMax);
...
function maxMin(arraynumber) {
    for (let i = 0; i< arraynumber.length; i++)
    {
        ...
        let maxToMin = arraynumber[i];
        arraynumber[i]=arraynumber[max];
        arraynumber[max]=maxToMin;
    }
}
let arrayMaxMin = [1,4,2,5,3,6]
maxMin(arrayMaxMin);
